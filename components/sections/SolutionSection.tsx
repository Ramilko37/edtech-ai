      ...
      <div className="section-shell">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {solutionCards.map(({ title, text, icon: Icon }) => (
            <Card
              key={title}
              className="group p-5 transition duration-200 hover:-translate-y-1 hover:border-blueElectric/40 hover:shadow-soft"
            >
              <div className="mb-5 grid size-11 place-items-center rounded-lg bg-cyanGlow/15 text-blueCore transition group-hover:bg-blueElectric group-hover:text-white">
